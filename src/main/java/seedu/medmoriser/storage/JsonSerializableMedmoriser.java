...
class JsonSerializableMedmoriser {
    ...
    /**
     * Constructs a {@code JsonSerializableMedmoriser} with the given persons.
     */
    @JsonCreator
    public JsonSerializableMedmoriser(@JsonProperty("persons") List<JsonAdaptedPerson> persons) {
